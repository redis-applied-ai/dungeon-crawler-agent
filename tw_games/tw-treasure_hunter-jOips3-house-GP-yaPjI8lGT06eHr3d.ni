...
The cellar part 0 is some text that varies. The cellar part 0 is "You've just walked into a cellar. You begin to take stock of what's here.
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, head east. That done, retrieve the passkey from the floor of the shower. And once you've d".
The objective part 1 is some text that varies. The objective part 1 is "one that, you win!".
